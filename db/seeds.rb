...
cat1.products.create!(
  {
    name: "Lion Grapevine",
    description:
      "The Lion Grapevine is an uncommon, modest plant and can be found only in some humid regions. It blooms once a year, for 4 months.
...
cat1.products.create!(
  {
    ...
    description:
      "The Bone Coneflower is an uncommon, small plant and can be found only in some forests. It blooms in early spring.
...
cat1.products.create!(
  {
    name: "Enirthelda",
    description:
      "The Enirthelda is an uncommon, large plant and can be found only in some forests. It blooms once a year, for 2 months.
...
cat1.products.create!(
  {
    name: "Swamp Root",
    description:
      "The Swamp Root is a very common, huge plant and can be found in most subarctic regions. It blooms once a year, for 1 week.
...
cat2.products.create!(
  {
    name: "Sweet Hops",
    description:
      "The Sweet Hop is a rare, medium-sized plant and can be found only at lake borders. It blooms twice a year, for 2 months.
...
cat2.products.create!(
  {
    name: "Tangle Azolla",
    description:
      "The Tangle Azolla is a very rare, modest plant and can be found in any cold region. It blooms once a year, for 2 months.
...
cat2.products.create!(
  {
    name: "Krapliper",
    description:
      "The Krapliper is a rare, modest plant and can be found only in deserts. It blooms once a year, for 2 weeks.
...
cat3.products.create!(
  {
    name: "Eesrorn",
    description:
      "The Eesrorn is a very common, tall plant and can be found in most subarctic regions. It blooms twice a year, for 2 months.
...
cat3.products.create!(
  {
    name: "Void Fennel",
    description:
      "The Void Fennel is an uncommon, tall plant and can be found only in some snowy regions. It blooms in late autumn.
...
cat3.products.create!(
  {
    name: "Cliff Collard",
    description:
      "The Cliff Collard is a very rare, tiny plant and can be found in damp places. It blooms twice a year, for 1 week.
